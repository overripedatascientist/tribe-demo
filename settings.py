...
LANGFLOW_JSON_FILE = os.path.join(LANGFLOW_DIR, "TRIBE for Climate Convos.json")
CONF_FILE = os.path.join(CONF_DIR, "config.json")

ASTRADB_BATCH_SIZE: int = 5
ASTRADB_RESULT_SIZE: int = 25
ASTRADB_SEARCH_TYPE: str = "Similarity"  # or "Similarity with score threshold"
ASTRADB_SEARCH_SCORE_THRESHOLD: float = 0.7
